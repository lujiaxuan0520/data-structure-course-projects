...
int main(void)
{
    ...
    while (c != '0')	{
        ...
        cout << endl << "9. 显示二叉排序树.";
        cout << endl << "a. 求二叉树的深度.";
        cout << endl << "b. 求二叉树的叶子数.";
        cout << endl << "c. 交换二叉树的左右子树（递归）.";
        cout << endl << "d. 交换二叉树的左右子树（非递归）.";
		cout << endl << "0. 退出";
		cout << endl << "选择功能(0~7):";
		cin >> c;
		switch (c) 	{
            ...
            case 'a':
				cout << endl;
				cout << "二叉树的深度（递归）为：" << bt.Depth() << endl;
				cout << "二叉树的深度（非递归）为：" << bt.Depth2() << endl;
				break;
            case 'b':
				cout << endl;
				cout << "二叉树的叶子数（递归）为：" << bt.LeafCount() << endl;
				cout << "二叉树的叶子数（非递归）为：" << bt.LeafCount2() << endl;
				break;
            case 'c':
                cout<<endl;
                cout << "使用递归交换二叉树的左右子树后：" <<endl;
                bt.ExchangeChild();
                DisplayBTWithTreeShape(bt);
                break;
            case 'd':
                cout<<endl;
                cout << "使用非递归交换二叉树的左右子树后：" <<endl;
                bt.ExchangeChild2();
                DisplayBTWithTreeShape(bt);
                break;
		}
